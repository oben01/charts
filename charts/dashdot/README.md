...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"mauricenino/dashdot","tag":"5.8.5"}` | Number of replicas |
| image.pullPolicy | string | `"IfNotPresent"` | Image pull policy |
| image.repository | string | `"mauricenino/dashdot"` | Image repository |
| image.tag | string | `"5.8.5"` | Overrides the image tag whose default is the chart appVersion |
